...
from .helpers import photo_path_aws_instance
from .constants import OPERADORES
...
class Usuario(AbstractUser):
    ...
    avatar = models.ImageField(upload_to=photo_path_aws_instance, blank=True,
    null=True)
...
class DispositivoMovil(models.Model):
        ...
        numero_celular = models.CharField(max_length=15, verbose_name="Número decelular")
        operador = models.CharField(max_length=10, choices=OPERADORES,
        verbose_name="Operador")
        marca = models.CharField(max_length=50, null=True, blank=True)
        modelo = models.CharField(max_length=50, null=True, blank=True)
        sistema_operativo = models.CharField(max_length=50, null=True, blank=True)
        o = models.CharField(max_length=20, null=True, blank=True)
...
class UbicacionDispositivo(models.Model):
        dispositivo = models.ForeignKey('DispositivoMovil',
        on_delete=models.CASCADE, related_name='ubicaciones')
